-- FlexLM Broker — PostgreSQL schema
-- Apply with: psql -U broker -d flexlm -f sql/001_schema.sql
...
CREATE INDEX IF NOT EXISTS idx_checkouts_open           ON checkouts(feature, username)
...
-- Convenience view: current license utilisation across all backends
